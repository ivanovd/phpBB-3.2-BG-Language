...
$lang = array_merge($lang, array(
	...
	'SEARCH_KEYWORDS_EXPLAIN'	=> 'Сложете <strong>+</strong> пред думата, която трябва да бъде намерена и <strong>-</strong> пред думата, която искате да изключите от търсенето. Можете да изредите думи оградени в скоби и разделени с <strong>|</strong> ако само една от тези думи трябва да бъде намерена. Използвайте * като заместващ символ за частични търсения.',
