...
$lang = array_merge($lang, array(
	...
	'RECAPTCHA_NOSCRIPT'			=> 'Моля, разрешете JavaScript във Вашия браузър за да заредите проверката против ботове.',

	'RECAPTCHA_PUBLIC'				=> 'Публичен reCaptcha ключ',
	'RECAPTCHA_PUBLIC_EXPLAIN'		=> 'Вашият публичен reCaptcha ключ. Ключът може да бъде взет от <a href="http://www.google.com/recaptcha">www.google.com/recaptcha</a>.',
	'RECAPTCHA_PRIVATE'				=> 'Частен reCaptcha ключ',
	'RECAPTCHA_PRIVATE_EXPLAIN'		=> 'Вашият частен reCaptcha ключ. Ключът може да бъде взет от <a href="http://www.google.com/recaptcha">www.google.com/recaptcha</a>.',
