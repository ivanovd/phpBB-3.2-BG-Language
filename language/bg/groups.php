...
$lang = array_merge($lang, array(
	...
	'GROUP_IS_HIDDEN'					=> 'Това е скрита група, само членове на тази група могат да видят потребителите в нея.',
	'GROUP_IS_OPEN'						=> 'Това е отворена група, потребителите могат да изпращат искания за присъединяване към нея.',
	...
	'FORUM_UNDISCLOSED'					=> 'Модерация на скрит(и) форум(и)',

	'LOGIN_EXPLAIN_GROUP'	=> 'Трябва да влезете в профила си за да можете да видите детайлите на групата.',
	...
	'NOT_RESIGN_FROM_DEFAULT_GROUP'	=> 'Не можете да напуснете групата Ви по подразбиране.',
